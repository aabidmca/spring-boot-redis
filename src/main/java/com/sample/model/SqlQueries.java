...
public class SqlQueries {
	...
	public static final String FETCH_CATEGORY_TREE = "\n" +
	    	"SELECT \n" + 
	    	"	cce.parent_id as parentId, cce.entity_id as entityId, cce.position as position, \n" + 
	...
	public static final String PRODUCT_COUNT_IN_CATEGORY = 
		"SELECT category_id as entityId, count(category_id) as products from catalog_category_product GROUP BY category_id";
